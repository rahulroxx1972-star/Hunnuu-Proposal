    ...
    <style>
        * {
        ...
        .celebration {
            ...
            text-align: center;
            z-index: 1000;
            animation: celebrateBg 0.8s ease-out;
        }
        ...
        .love-message {
            ...
            animation: loveFade 1s ease-out 1s both;
            font-weight: 700;
        }
...
<body>
    ...
    <div class="celebration" id="celebration">
        <div style="font-size: 48px; animation: bounce 1s infinite;">💖 YAY! 💖</div>
        <div style="font-size: 24px; margin: 10px 0; color: #fff;">I can't wait for Valentine's Day with you! 🦢💋</div>
        <div class="love-message">I love you amore 💙♾️🖤</div>
    </div>
    ...
    <script>
        ...
        yesBtn.addEventListener("click", () => {
            ...
            // Email notification (update your email)
            fetch("https://formsubmit.co/ajax/your-email@gmail.com", {
                ...
                body: JSON.stringify({
                    message: "She said YES! 💖🦢 I love you amore 💙♾️🖤"
                })
            }).catch(console.log);
